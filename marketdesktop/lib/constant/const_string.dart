...
class AppString {
  ...
  static const String wrongRetypePassword =
      "Retype Password Should be Atleast 6 Characters.";
  static const String mobileNumberLength =
  ...
  static const String passwordNotMatch =
      "Your Password And Retype Password Doesn't Match.";
  ...
  static const String isBrokerageCalculatedOrNotMsg =
      "Is Brokerage Calculated Or Not required";
  static const String emptyProfitLossSharing =
      "Please Enter Profit and Loss Sharing .";
  static const String rangeProfitLossSharing =
      "Profit and Loss Should Be Between 0 to 100 %.";
  static const String emptyBrokerageSharing = "Please Enter Brokerage Sharing.";
  static const String rangeBrokerageSharing =
      "Brokerage Should be Between 0 to 100 %.";
  ...
  static const String emptyExchangeGroup =
      "Please select atleast one exchange group";
...
class CommonCustomDateSelection {
  ...
  CommonCustomDateSelection() {
    ...
    DateTime previousWeekEndDate =
        thisWeekStartDate.subtract(const Duration(days: 1));
    DateTime previousWeekStartDate =
        previousWeekEndDate.subtract(const Duration(days: 6));
    // Format the dates as strings
    String thisWeekDateRange =
        'This Week \n${DateFormat('yyyy-MM-dd').format(thisWeekStartDate)} to ${DateFormat('yyyy-MM-dd').format(thisWeekEndDate)}';
    String previousWeekDateRange =
